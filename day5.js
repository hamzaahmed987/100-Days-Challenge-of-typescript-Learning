...
*/
var favoriteTransports = ["Honda Civic", "Ford Truck", "Hummer H2"];
for (var _i = 0, favoriteTransports_1 = favoriteTransports; _i < favoriteTransports_1.length; _i++) {
    ...
    console.log("I would love to own a ".concat(transport, "."));
}
/*
...
*/
// let guests :string[] = ["Kalia","Shahkala","Lota","Kallu Ustaad"];
// let cannotAttend:string= "Kallu Ustaad"
// console.log(`${cannotAttend} can't attend the dinner`)
// let newGuest : string = "jack sparrow"
